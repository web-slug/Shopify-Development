...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    this.desktopLayout = this.parentElement.getAttribute("data-desktop-layout");
    console.log(this.desktopLayout,"this.desktopLayout")
    this.slider_ul = this.querySelector(
      'media-gallery[data-desktop-layout="thumbnail_slider_vertical"] slider-component > ul'
    );
    console.log(this.slider_ul,"this.slider_ul")
